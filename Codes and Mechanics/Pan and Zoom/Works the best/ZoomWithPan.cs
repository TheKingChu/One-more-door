...
public class ZoomWithPan : MonoBehaviour
{
    public float scale_factor = 0.08f;
    public float MAXSCALE = 5.0f, MIN_SCALE = 1.0f; // zoom-in and zoom-out limits
    public float smoothDrag = 0.05f; // smoothness in drag
